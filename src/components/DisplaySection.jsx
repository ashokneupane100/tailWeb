  ...
  return (
    ...
    <div className='m-6 grid grid-cols-1 md:grid-cols-2 items-center md:mb-12 px-4'>
      ...
      <div className='text-center md:text-left'>
        <h1 className='text-4xl font-bold text-gray-800'>Hi, I am Ashok Neupane</h1>
        <p className='text-red-500 font-semibold text-xl mt-2'>Full Stack Web Developer, JavaScript Lover, Tech Entrepreneur</p>
